Emet:
  5.2:
    installer: 'https://s3.amazonaws.com/systemprep-repo/windows/emet/5.2/EMET+5.2+Setup.msi'
    full_name: 'EMET 5.2'
    reboot: False
    install_flags: ' ALLUSERS=1 /quiet /qn /norestart'
    msiexec: True
    uninstaller: 'https://s3.amazonaws.com/systemprep-repo/windows/emet/5.2/EMET+5.2+Setup.msi'
    uninstall_flags: ' /qn'
  5.1:
